...
def test_iso_with_z_is_utc() -> None:
    ...
    assert result == datetime(2026, 7, 21, 6, 30, 45, tzinfo=timezone.utc)
...
def test_explicit_unit_ms_overrides_heuristic() -> None:
    ...
    assert result == datetime(1970, 1, 20, 16, 13, 20, tzinfo=timezone.utc)
...
def test_explicit_unit_s_overrides_heuristic() -> None:
    ...
    assert forced_ms == datetime(2023, 11, 14, 22, 13, 20, tzinfo=timezone.utc)
